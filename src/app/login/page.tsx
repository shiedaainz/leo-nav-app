      ...
      >
        ...
        <form className="space-y-5 px-6 py-6 sm:px-8 sm:py-7" onSubmit={handleSubmit}>
          ...
          <button
            ...
            className="min-h-12 w-full rounded-xl border border-white/15 py-3 font-semibold transition hover:bg-white/10"
          >
            Entrar como visitante
          </button>
          <div className="text-center text-sm text-[var(--up-gray)]/80">
            No tienes cuenta?{" "}
            <Link href="/register" className="font-semibold text-white hover:text-[var(--up-gray)]">
              Crear cuenta
            </Link>
          </div>
        </form>
